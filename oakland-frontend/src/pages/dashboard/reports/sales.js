...
import { PerformanceIndicators } from '../../../components/dashboard/reports/performance-indicators';
import { ProductsBreakdown } from '../../../components/dashboard/reports/products-breakdown';
...
const ReportsSales = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Reports: Sales | Carpatin Dashboard
        </title>
      </Head>
      <div>
        <Grid
