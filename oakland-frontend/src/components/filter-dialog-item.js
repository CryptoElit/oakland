...
export const FilterDialogItem = (props) => {
    const { properties, filter, index, onAddFilter, onRemoveFilter, onPropertyChange, onOperatorChange, onValueChange, operators } = props;
...
value={operator.value}>
        ...
        {!filter.operator.typesAccepted.includes('blank') && (filter.operator.typesAccepted.includes('date')
            ? (
<Grid item
xs={12}>
                <DateField fullWidth
